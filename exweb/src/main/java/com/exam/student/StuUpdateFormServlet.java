...
@WebServlet("/student/updateform.do")
public class StuUpdateFormServlet extends HttpServlet {		
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/jsp/student/StuUpdateForm.jsp").forward(req, resp);
